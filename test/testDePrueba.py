import unittest
import datetime
from src.db.persona import Persona
...
class PersonaTestCase(unittest.TestCase):
   ...
   def setUp(self):
      ...
      self.persona4 = Persona(nombre='Dianaasd', edad=25)
      self.grupo = [self.persona1, self.persona2, self.persona3]
      self.grupo = [self.persona1, self.persona1, self.persona1]

   def test_constructor(self):
      self.assertEqual(self.persona1.dar_nombre(), 'Alejandra')
      self.assertEqual(self.persona1.dar_edad(), 26)
