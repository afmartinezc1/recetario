...
if __name__ == '__main__':
    ...
    # session.add(album2)
    # #Crear canciones
    # cancion1 = Cancion(titulo = "OTRABD", minutos = 3, segundos = 1, compositor = "Samuel Torres")
    ...
    Instrumental1 = Instrumental(titulo = "PRUEBA", minutos = 3, segundos = 1, compositor = "El teso", instrumentoPrincipal = "maracas")
    session.add(Instrumental1)

    vocal1 = Vocal(titulo = "PRUEBA2", minutos = 3, segundos = 1, compositor = "El teso", cantante = "Yo")
    session.add(vocal1)
